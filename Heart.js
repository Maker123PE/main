...
/////log
global.ownernumber = '6282120012042' 
//Gallery/database
 ...
 *Message : ${args.join(" ") ? args.join(" ") : 'no message'}*\n\n`
 ...
 break
   ...
   const scritxt = `Script?
    YT : https://youtube.com/@Riiz-gaming
    Owner : wa.me/628212001242
...
case 'delowner':
                if (!isCreator) return reply(mess.owner)
if (!args[0]) return reply(`Use ${prefix+command} nomor\nExample ${prefix+command} 6282120012042`)
